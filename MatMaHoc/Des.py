# DES Implementation (Pure Python - Full)
...
if __name__ == '__main__':
    plain_text = "D22CQAT01-N"      # 8 ký tự = 64 bit
    key_text = "N22DCAT032"        # 8 ký tự = 64 bit

    plain_bin = str_to_bin(plain_text)
    key_bin = str_to_bin(key_text)

    cipher_bin = des_encrypt_block(plain_bin, key_bin)
    cipher_text = bin_to_str(cipher_bin)

    print("Plain Text: ", plain_text)
    print("Key       : ", key_text)
    print("Cipher (bin):", cipher_bin)
    print("Cipher (txt):", cipher_text)
